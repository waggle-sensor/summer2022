...
target device.
  ...
  ----------------------------------------------
   ...
   Examples for ONLINE massflash blob generation method:
     ...
     NOTE: SBKPKC is supported only in OFFLINE mode by jetson-tx2,
           jetson-xavier, and jetson-xavier-nx-devkit-emmc.
